        ...
        <form class="form-horizontal" action="{{ route('episodes.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="time" id="time" placeholder="آدرس ویدیو رو وارد کنید" value="{{ old('time') }}">
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <div class="col-sm-6">
                    <label for="videoUrl" class="control-label">آبلود ویدیو</label>
                    <input type="text" class="form-control" name="videoUrl" id="videoUrl" placeholder="آدرس ویدیو رو وارد کنید" value="{{ old('videoUrl') }}">
                </div>
                <div class="col-sm-6">
